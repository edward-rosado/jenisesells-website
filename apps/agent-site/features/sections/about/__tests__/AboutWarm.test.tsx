...
import { AboutWarm } from "../AboutWarm";
...
describe("AboutWarm", () => {
  it("renders the default heading About", () => {
    render(<AboutWarm agent={ACCOUNT} data={ABOUT_DATA} />);
  ...
  it("renders a custom title when provided via data.title", () => {
    ...
    render(<AboutWarm agent={ACCOUNT} data={dataWithTitle} />);
  ...
  it("handles array bio with multiple paragraphs", () => {
    ...
    render(<AboutWarm agent={ACCOUNT} data={arrayBio} />);
  ...
  it("renders agent photo when headshot_url is set", () => {
    const agentWithPhoto = {
      ...ACCOUNT,
      agent: { ...ACCOUNT.agent!, headshot_url: "/agents/test/headshot.jpg" },
    };
  ...
  it("uses id=about for anchor linking", () => {
    const { container } = render(<AboutWarm agent={ACCOUNT} data={ABOUT_DATA} />);
  ...
  it("does not render credentials section when empty", () => {
    ...
    render(<AboutWarm agent={ACCOUNT} data={noCreds} />);
