...
import { ProfilesCards } from "@/components/sections/profiles/ProfilesCards";
...
describe("ProfilesCards", () => {
  it("renders all profile items", () => {
    render(<ProfilesCards items={ITEMS} title="Our Team" />);
  ...
  it("links each profile to /agents/{id}", () => {
    render(<ProfilesCards items={ITEMS} />);
  ...
  it("renders placeholder when no headshot", () => {
    render(<ProfilesCards items={[ITEMS[0]]} />);
  ...
  it("renders title and subtitle when provided", () => {
    render(<ProfilesCards items={ITEMS} title="Meet the Team" subtitle="Our experts" />);
  ...
  it("uses id=profiles for anchor linking", () => {
    const { container } = render(<ProfilesCards items={ITEMS} />);
  ...
  it("renders empty section when items is empty", () => {
    const { container } = render(<ProfilesCards items={[]} />);
    expect(container.querySelector("#profiles")).toBeInTheDocument();
