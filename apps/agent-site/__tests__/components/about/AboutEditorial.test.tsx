...
describe("AboutEditorial", () => {
  ...
  it("renders custom title when provided in data", () => {
    ...
    render(<AboutEditorial agent={AGENT} data={dataWithTitle} />);
  ...
  it("renders multiple bio paragraphs when bio is an array", () => {
    render(<AboutEditorial agent={AGENT} data={DATA_ARRAY_BIO} />);
  ...
  it("does not render credentials list when credentials is empty", () => {
    render(<AboutEditorial agent={AGENT} data={DATA_NO_CREDENTIALS} />);
  ...
  it("renders agent headshot when headshot_url is provided", () => {
    const agentWithHeadshot = {
      ...AGENT,
      identity: { ...AGENT.identity, headshot_url: "/agents/victoria/headshot.jpg" },
    };
  ...
  it("renders minimal agent correctly", () => {
    render(<AboutEditorial agent={AGENT_MINIMAL} data={DATA_NO_CREDENTIALS} />);
