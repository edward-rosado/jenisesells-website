...
public static class CloudflareDiagnostics
{
    ...
    public static readonly Counter<long> R2Reads = Meter.CreateCounter<long>(
        "cloudflare.r2.reads", description: "Cloudflare R2 read operations");
    public static readonly Counter<long> R2Writes = Meter.CreateCounter<long>(
        "cloudflare.r2.writes", description: "Cloudflare R2 write operations");
    public static readonly Counter<long> R2Deletes = Meter.CreateCounter<long>(
        "cloudflare.r2.deletes", description: "Cloudflare R2 delete operations");
    public static readonly Counter<long> SaasOperations = Meter.CreateCounter<long>(
        "cloudflare.saas.operations", description: "Cloudflare For SaaS hostname operations");
