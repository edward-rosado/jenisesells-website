 ...
 *
 * SECURITY: dangerouslySetInnerHTML is safe here because content is
 * server-generated template literals from legal pages only.
...
export function MarkdownContent({ content }: MarkdownContentProps) {
  ...
  // nosec: content is server-generated template literals from legal pages only.
  // Never pass user-supplied content to this component.
  return (
    <div
      ...
      dangerouslySetInnerHTML={{ __html: html }} // nosec: server-generated content only
    />
  );
}
